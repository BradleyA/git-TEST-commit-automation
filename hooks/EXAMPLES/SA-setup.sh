#!/bin/bash
# 	hooks/EXAMPLES/SA-setup.sh  3.1.191.1939  2020-12-02T14:57:20.672679-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 3.1.190  
