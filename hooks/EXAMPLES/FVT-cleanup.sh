#!/bin/bash
# 	hooks/EXAMPLES/FVT-cleanup.sh  3.1.266.2025  2020-12-04T17:13:27.865157-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 3.1.265-1-gc61878b  
