#!/bin/bash
# 	hooks/EXAMPLES/FVT-cleanup.sh  3.1.269.2028  2020-12-04T21:51:40.790457-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 3.1.268  
