#!/bin/bash
# 	hooks/EXAMPLES/FVT-cleanup.sh  3.1.265.2023  2020-12-04T16:31:02.136259-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 3.1.264-1-g0076803  
