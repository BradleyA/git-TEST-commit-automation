#!/bin/bash
# 	hooks/EXAMPLES/FVT-cleanup.sh  3.1.263.2020  2020-12-04T16:23:19.989071-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 3.1.262-1-g73de1ed  
