#!/bin/bash
# 	hooks/EXAMPLES/FVT-cleanup.sh  3.1.264.2021  2020-12-04T16:28:45.702702-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 3.1.263  
