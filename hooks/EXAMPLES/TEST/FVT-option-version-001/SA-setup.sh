#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-version-001/SA-setup.sh  2.28.309  2019-09-02T11:50:52.527054-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.27-1-g33b15cd  
