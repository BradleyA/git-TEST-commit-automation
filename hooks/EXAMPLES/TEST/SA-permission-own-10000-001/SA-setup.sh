#!/bin/bash
# 	hooks/EXAMPLES/TEST/SA-permission-own-10000-001/SA-setup.sh  2.67.496  2019-09-13T11:59:10.910857-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.66-2-g35d6ec8  
# 	   copied latest version of SA-setup.sh 
# 	hooks/EXAMPLES/SA-setup.sh  2.59.423  2019-09-08T22:15:35.308620-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.58  
