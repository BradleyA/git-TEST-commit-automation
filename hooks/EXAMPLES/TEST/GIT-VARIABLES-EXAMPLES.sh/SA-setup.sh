#!/bin/bash
# 	hooks/EXAMPLES/TEST/GIT-VARIABLES-EXAMPLES.sh/SA-setup.sh  2.67.496  2019-09-13T11:59:09.874449-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.66-2-g35d6ec8  
