#!/bin/bash
# 	hooks/EXAMPLES/FVT-setup.sh  2.256.1045  2020-01-19T09:40:05.737925-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  dev  uadmin  five-rpi3b.cptx86.com 2.255  
