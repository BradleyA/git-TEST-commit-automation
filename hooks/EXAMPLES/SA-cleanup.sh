#!/bin/bash
# 	hooks/EXAMPLES/SA-cleanup.sh  3.1.268.2027  2020-12-04T21:41:56.018553-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 3.1.267  
