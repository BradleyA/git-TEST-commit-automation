#!/bin/bash
# 	hooks/TEST/pre-commit/SA-setup.sh  2.28.309  2019-09-02T11:50:53.068730-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.27-1-g33b15cd  
# 	   SA-setup.sh  change permission to 775 and update Production standard 1.3.496 DEBUG variable 
# 	hooks/TEST/pre-commit/SA-setup.sh  2.4.279  2019-09-01T15:00:26.449402-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.3-5-gaab1b24  
