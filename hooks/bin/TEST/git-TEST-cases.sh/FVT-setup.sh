#!/bin/bash
# 	hooks/bin/TEST/git-TEST-cases.sh/FVT-setup.sh  2.269.1066  2020-01-20T12:55:38.898517-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  dev  uadmin  five-rpi3b.cptx86.com 2.268  
...
#86# hooks/bin/TEST/git-TEST-cases.sh/FVT-setup.sh  -  This test script is optional.  It is for
