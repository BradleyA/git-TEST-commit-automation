#!/bin/bash
# 	hooks/bin/TEST/git-TEST-cases.sh/FVT-setup.sh  2.382.1271  2020-01-26T08:32:43.074884-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.381  
