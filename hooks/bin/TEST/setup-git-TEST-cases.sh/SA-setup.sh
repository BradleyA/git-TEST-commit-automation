#!/bin/bash
# 	hooks/bin/TEST/setup-git-TEST-cases.sh/SA-setup.sh  2.28.309  2019-09-02T11:50:53.221630-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.27-1-g33b15cd  
