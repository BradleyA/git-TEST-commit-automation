#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.296.1171  2020-01-23T16:09:30.686258-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.295  
# 	   hooks/bin/git-TEST-cases.sh   run some of the test cases 
