#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.334.1213  2020-01-23T23:45:07.373480-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.333  
# 	   testing -n 
