#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.507.1440  2020-02-02T14:20:39.376723-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.506  
# 	   testing 
