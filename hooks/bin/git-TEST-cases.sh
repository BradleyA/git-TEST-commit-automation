#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.252.1041  2020-01-18T23:40:17.231063-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  dev  uadmin  five-rpi3b.cptx86.com 2.251  
# 	   hooks/bin/git-TEST-cases.sh   debug custom test cases for FVT options #36 
