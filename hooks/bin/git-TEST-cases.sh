#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.140.789  2019-09-27T18:56:53.341097-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.139  
# 	   test post-commit removing COMMIT_FILE_LIST if not DEBUG == 1 
