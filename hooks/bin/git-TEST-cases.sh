#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.325.1203  2020-01-23T22:50:55.851140-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.324  
# 	   testing --none 
