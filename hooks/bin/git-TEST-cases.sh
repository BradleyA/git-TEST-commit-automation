#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.330.1209  2020-01-23T23:23:25.261314-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.329  
# 	   testing -n --hooks 
