#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.510.1449  2020-02-03T10:25:27.452535-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.509-6-g535e41e  
# 	   testing 
