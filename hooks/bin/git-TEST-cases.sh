#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.505.1438  2020-02-02T13:55:20.435881-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.504  
# 	   testing 
