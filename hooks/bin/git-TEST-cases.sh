#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.381.1270  2020-01-26T08:23:28.826076-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.380  
# 	   hooks/bin/git-TEST-cases.sh   Use short test case name 
