#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.493.1418  2020-02-01T12:36:48.623481-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.492-3-gc4332d0  
# 	   testing 
