#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.511.1450  2020-02-03T10:35:01.601425-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.510  
# 	   testing 
