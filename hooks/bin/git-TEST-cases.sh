#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.472.1382  2020-01-31T20:45:02.782386-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.471  
# 	   testing 
