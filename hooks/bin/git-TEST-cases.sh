#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.333.1212  2020-01-23T23:41:05.957565-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.332  
# 	   testing -n 
