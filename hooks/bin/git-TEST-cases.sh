#!/bin/bash
# 	hooks/bin/git-TEST-cases.sh  2.334.1214  2020-01-23T23:52:11.978862-06:00 (CST)  https://github.com/BradleyA/git-TEST-commit-automation.git  master  uadmin  five-rpi3b.cptx86.com 2.333-1-g7c75b5e  
# 	   testing -n -hooks 
