#!/bin/bash
# 	hooks/bin/check-git-TEST-cases.sh  2.45.370  2019-09-05T20:28:25.092304-05:00 (CDT)  https://github.com/BradleyA/git-TEST-commit-automation.git  uadmin  five-rpi3b.cptx86.com 2.44  
# 	   #1 #2 #3 #14  added #86# 
