#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-version-003/SAST-setup.sh  3.321.552  2019-08-17T10:49:56.956158-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.320  
# 	   FVT-option-version-003   added SAST test cases 
###
