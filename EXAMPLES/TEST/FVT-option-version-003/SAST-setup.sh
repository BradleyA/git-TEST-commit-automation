#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-version-003/SAST-setup.sh  3.421.662  2019-08-21T13:50:17.387909-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.420  
# 	   hooks/EXAMPLES/TEST/FVT-option-version-003/SAST-setup.sh   get latest version 
###
