#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-005/SAST-setup.sh  3.317.548  2019-08-17T10:44:49.350401-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.316  
# 	   FVT-option-help-005   added SAST test cases 
###
