#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-005/SAST-setup.sh  3.402.643  2019-08-21T11:10:01.371052-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.401  
# 	   hooks/EXAMPLES/TEST/FVT-option-help-005/SAST-setup.sh  get latest version 
###
