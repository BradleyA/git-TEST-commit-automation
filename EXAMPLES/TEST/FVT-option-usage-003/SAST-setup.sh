#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-usage-003/SAST-setup.sh  3.411.652  2019-08-21T11:42:20.891794-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.410  
# 	   hooks/EXAMPLES/TEST/FVT-option-usage-003/SAST-setup.sh  get latest version 
###
