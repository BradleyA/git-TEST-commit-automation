#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-usage-003/SAST-setup.sh  3.324.555  2019-08-17T11:34:39.796878-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.323  
# 	   FVT-option-usage-003   added SAST test cases 
###
