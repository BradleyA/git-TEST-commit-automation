#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-usage-002/SAST-setup.sh  3.323.554  2019-08-17T11:32:12.852826-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.322  
# 	   FVT-option-usage-002   added SAST test cases 
###
