#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-usage-002/SAST-setup.sh  3.409.650  2019-08-21T11:31:18.479470-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.408  
# 	   hooks/EXAMPLES/TEST/FVT-option-usage-002/SAST-setup.sh  get latest version 
###
