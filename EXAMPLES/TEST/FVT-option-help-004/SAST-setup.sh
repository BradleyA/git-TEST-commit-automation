#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-004/SAST-setup.sh  3.316.547  2019-08-17T10:43:24.619288-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.315  
# 	   FVT-option-help-004   added SAST test cases 
###
