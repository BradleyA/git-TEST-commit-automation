#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-004/SAST-setup.sh  3.400.641  2019-08-21T11:03:41.253642-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.399  
# 	   hooks/EXAMPLES/TEST/FVT-option-help-004/SAST-setup.sh  get latest version 
###
