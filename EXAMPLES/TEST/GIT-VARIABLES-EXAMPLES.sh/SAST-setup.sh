#!/bin/bash
# 	hooks/EXAMPLES/TEST/GIT-VARIABLES-EXAMPLES.sh/SAST-setup.sh  3.492.747  2019-09-01T00:08:58.911668-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.491  
