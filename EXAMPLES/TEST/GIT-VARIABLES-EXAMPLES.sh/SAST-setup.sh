#!/bin/bash
# 	hooks/EXAMPLES/TEST/GIT-VARIABLES-EXAMPLES.sh/SAST-setup.sh  3.425.666  2019-08-21T14:30:09.281872-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.424  
# 	   hooks/EXAMPLES/TEST/GIT-VARIABLES-EXAMPLES.sh/SAST-setup.sh  get latest version 
###
