#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-version-002/SAST-setup.sh  3.416.657  2019-08-21T12:02:16.804171-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.415  
# 	   hooks/EXAMPLES/TEST/FVT-option-version-002/SAST-setup.sh   get latest version 
###
