#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-version-002/SAST-setup.sh  3.320.551  2019-08-17T10:48:53.785180-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.319  
# 	   FVT-option-version-002   added SAST test cases 
###
