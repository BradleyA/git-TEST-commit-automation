#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-usage-001/SAST-setup.sh  3.406.647  2019-08-21T11:25:05.000234-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.405  
# 	   hooks/EXAMPLES/TEST/FVT-option-usage-001/SAST-setup.sh   get latest version 
###
