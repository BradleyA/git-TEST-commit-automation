#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-setup.sh/SAST-setup.sh  3.423.664  2019-08-21T14:00:43.935505-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.422  
# 	   hooks/EXAMPLES/TEST/FVT-setup.sh/SAST-setup.sh   get latest version 
###
