#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-006/SAST-setup.sh  3.318.549  2019-08-17T10:46:15.392292-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.317  
# 	   FVT-option-help-006   added SAST test cases 
###
