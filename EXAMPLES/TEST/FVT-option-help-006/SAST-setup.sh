#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-006/SAST-setup.sh  3.404.645  2019-08-21T11:18:27.655250-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.403  
# 	   hooks/EXAMPLES/TEST/FVT-option-help-006/SAST-setup.sh   get latest version from EXAMPLES 
###
