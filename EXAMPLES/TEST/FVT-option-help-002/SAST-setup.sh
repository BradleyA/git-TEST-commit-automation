#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-002/SAST-setup.sh  3.394.635  2019-08-21T10:24:38.778264-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.393  
# 	   hooks/EXAMPLES/TEST/FVT-option-help-002/SAST-setup.sh   get latest version 
###
