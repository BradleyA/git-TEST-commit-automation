#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-002/SAST-setup.sh  3.314.545  2019-08-17T10:19:48.394884-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.313  
# 	   FVT-option-help-002   added SAST test cases 
###
