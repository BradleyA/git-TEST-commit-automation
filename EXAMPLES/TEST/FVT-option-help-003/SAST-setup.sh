#!/bin/bash
# 	hooks/EXAMPLES/TEST/FVT-option-help-003/SAST-setup.sh  3.396.637  2019-08-21T10:42:58.741946-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.395  
# 	   hooks/EXAMPLES/TEST/FVT-option-help-003/SAST-setup.sh  get latest version 
###
