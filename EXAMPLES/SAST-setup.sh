#!/bin/bash
# 	hooks/EXAMPLES/SAST-setup.sh  3.469.719  2019-08-27T16:10:00.934766-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.468-1-ga4d2cc4  
