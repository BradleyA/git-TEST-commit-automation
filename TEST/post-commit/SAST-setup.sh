#!/bin/bash
# 	hooks/TEST/post-commit/SAST-setup.sh  3.491.746  2019-08-31T23:37:25.594694-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.490  
# 	   hooks/TEST/post-commit/SAST-setup.sh  use latest SAST-setup.sh 
