#!/bin/bash
# 	hooks/TEST/post-commit/SAST-setup.sh  3.266.511  2019-08-16T14:52:10.347908-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.265-1-g5daf16a  
# 	   hooks/post-commit  added SAST test cases for post-commit 
###
