#!/bin/bash
# 	hooks/TEST/find-testcase.sh/SAST-setup.sh  3.309.538  2019-08-17T09:09:35.635217-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.308  
# 	   hooks/find-testcase.sh added SAST test cases #26 
###
