#!/bin/bash
# 	hooks/TEST/pre-commit/SAST-setup.sh  3.391.632  2019-08-21T00:34:53.146436-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.390-2-g89a0f1f  
